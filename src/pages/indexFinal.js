  ...
  return (
    <Layout>
      ...
      />
			...
			{/* <!--About Section--> */}
			<div className="w-full py-12 bg-white color-background">
				<div className="px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 mx-auto flex flex-wrap items-start md:flex-no-wraps">
			...
			<section className="bg-white py-8">
				<div className="container mx-auto flex flex-wrap pt-4 pb-12">
					<h2 className="w-full my-2 text-4xl leading-tight text-center">Our Guarantee</h2>
					<div className="w-full mb-4">	
						...
						<div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
							<div>
								...
								<p className="w-full font-bold text-xl px-6 pt-4 pb-2">Lorem ipsum dolor sit amet.</p>
