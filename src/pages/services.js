      ...
      {/* <!--Intro Section--> */}
        ...
        <div className="px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 mx-auto flex flex-wrap items-start md:flex-no-wraps mt-6 mb-20">
              ...
              <h3 className="text-center md:text-left text-3xl mb-8 leading-tight">
                Roofing Services
							...
							<p className="mb-10">We research and select only the finest and high quality materials for your roof repairs and replacements. Over the past decade, we have worked with many homeowners, small businesses, and corporate businesses to guarantee they can rest assured with our roofing services.</p>
						</div>
            <Link to="/roofing" 
        ...
        <div className="px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 mx-auto flex flex-wrap items-start md:flex-no-wraps mt-6 mb-20">
          <div className="my-4 w-full md:w-1/2 flex flex-col items-center justify-center px-6">
            ...
            <p className="mb-10">If you’re interested in renovating a room or simply want a change of scenery, we have a portfolio of options to review. From a fresh coat of paint, to new hardwood flooring, and any repair inbetween.  We will work with you to make your interior designs come to life.</p>
            </div>
      ...
      <div className="px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 mx-auto flex flex-wrap items-start md:flex-no-wraps mt-6 mb-20">
        ...
        <div className="my-4 w-full md:w-1/2 flex flex-col items-center justify-center px-6">
          <div>
            ...
            <p className="mb-10">We offer a full list of exterior services to make sure your property is protected from the outside in.</p>
          </div>
